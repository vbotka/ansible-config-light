...
[Documentation at readthedocs.io](https://ansible-config-light.readthedocs.io) [[PDF 271k](https://github.com/vbotka/ansible-config-light/blob/master/ansible-role-config-light.pdf)]
