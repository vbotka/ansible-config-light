...
[Documentation at rtfd.io](https://ansible-config-light.readthedocs.io) [[PDF 252k](https://github.com/vbotka/ansible-config-light/blob/master/ansible-role-config-light.pdf)]
