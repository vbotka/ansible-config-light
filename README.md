...
[Documentation at rtfd.io](https://ansible-config-light.readthedocs.io) [[PDF 254k](https://github.com/vbotka/ansible-config-light/blob/master/ansible-role-config-light.pdf)]
